...
if($row){
  ...
  //Display error if admin exist
    ...
    <strong>Sorry!</strong> User already Exists. Register or Try Again
  </div>';
...
//Confirm execute and display error or success message
  if($run){
    ...
    Admin registered successfully. Please log in with your inputted credentials.
  </div>';

  }else{

    echo '<div class="alert alert-dange text-center" role="alert">
    User already exists. Admin user could not be registered.
  </div>';
